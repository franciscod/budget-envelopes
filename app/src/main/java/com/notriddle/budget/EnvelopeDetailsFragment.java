...
public class EnvelopeDetailsFragment extends Fragment
    ...
    @Override public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.earn_menuItem) {
            SpendFragment sF = SpendFragment.newInstance(mId, SpendFragment.EARN);
            sF.show(getFragmentManager(), "dialog");
            return true;
        } else if (id == R.id.spend_menuItem) {
            SpendFragment sF = SpendFragment.newInstance(mId, SpendFragment.SPEND);
            sF.show(getFragmentManager(), "dialog");
            return true;
        } else if (id == R.id.color_menuItem) {
            changeColor();
            return true;
        }
